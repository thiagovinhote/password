...
export class ApiRetrieveCredential
  implements Usecase<RetrieveCredential.Params, RetrieveCredential.Result> {
  constructor(
    private readonly httpClient: HttpClient<RetrieveCredential.ResponseDTO>
  ) {}
