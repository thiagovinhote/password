...
export class ApiRevealCredential implements Usecase<RevealCredential.Params, RevealCredential.Result> {
  constructor(private readonly httpClient: HttpClient<RevealCredential.ResponseDTO>) { }
