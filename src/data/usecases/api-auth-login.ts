...
import { AccessDeniedError, InvalidCredentialsError, InvalidResourceError, UnexpectedError } from "../errors";
import { HttpClient, HttpMethodType, HttpStatusCode } from "../protocols/http/http-client";

export class ApiAuthLogin implements Usecase<AuthLogin.Params, AuthLogin.Result> {
